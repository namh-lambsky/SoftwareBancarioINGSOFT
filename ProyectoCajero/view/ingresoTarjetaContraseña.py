...
class Page3:
    def __init__(self,window):
        ...
        ingresoTarjetaBtIngresar= Button(self.window, padx=25,border=0, pady=15, bg="#7ed957")
        ingresoTarjetaBtIngresar.place(x=100,y=345)

        ingresoTarjetaBtFinalizar= Button(self.window, padx=25,border=0, pady=15, bg="#e61717")
        ingresoTarjetaBtFinalizar.place(x=100,y=445)



    def go_pageMenuTransaccion(self):
        win=Toplevel()
