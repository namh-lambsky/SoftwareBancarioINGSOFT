...
ingresarTarjetaBtIngresar= Button(ingresarTarjeta, padx=25,border=0, pady=15, bg="#7ed957",command = lambda: c.framesManager(framesList,IngresoTarjetaContraseña))
...
IngresoTarjetaBtIngresar= Button(IngresoTarjetaContraseña, padx=25,border=0, pady=15, bg="#7ed957",command = lambda: c.entryPasswordValidation(IngresoTarjetaContraseñaTx,framesList,MenuTransaccion))
...
RetirarDineroBtIngresar= Button(retirarDinero, padx=25,border=0, pady=15, bg="#7ed957",command = lambda: c.clearTextInput(RetirarDineroTx,framesList,consultarSaldo))
